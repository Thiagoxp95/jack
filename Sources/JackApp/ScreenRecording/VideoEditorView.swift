...
struct VideoEditorView: View {
    ...
    @State private var webcamExpanded = false
    @State private var cursorEffectsExpanded = false
    ...
    private var webcamPanel: some View {
        DisclosureGroup("Webcam", isExpanded: $webcamExpanded) {
    ...
    private var cursorEffectsPanel: some View {
        DisclosureGroup("Cursor Effects", isExpanded: $cursorEffectsExpanded) {
            VStack(alignment: .leading, spacing: 12) {
                VStack(alignment: .leading, spacing: 4) {
                    Text("Cursor Color")
                        .font(.caption)
    ...
    private var audioTracksPanel: some View {
        DisclosureGroup("Audio", isExpanded: $audioExpanded) {
            VStack(spacing: 12) {
                audioTrack(
                    label: "Mic Master",
                    icon: "mic.fill",
    ...
    private var subtitlesPanel: some View {
        DisclosureGroup("Subtitles", isExpanded: $subtitlesExpanded) {
            VStack(alignment: .leading, spacing: 12) {
                // Enable toggle
                ...
                if editor.subtitleConfig.enabled && !editor.subtitleLines.isEmpty {
                    ...
                    HStack {
                        ...
                        Picker("", selection: $editor.subtitleConfig.fontSize) {
                            Text("Small").tag(CGFloat(48))
                            Text("Medium").tag(CGFloat(72))
                            Text("Large").tag(CGFloat(96))
                            Text("Extra Large").tag(CGFloat(120))
                        }
                        .labelsHidden()
                        .fixedSize()
                    }
